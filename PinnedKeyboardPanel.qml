...
PanelWindow {
  ...
  mask: Region {
    x: root.dismissOnOutsideClick ? 0 : card.x
    y: root.dismissOnOutsideClick ? 0 : card.y
    width: root.dismissOnOutsideClick ? root.screenW : card.width
    height: root.dismissOnOutsideClick ? root.screenH : card.height
  }
